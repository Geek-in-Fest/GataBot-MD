          ...
          switch (_type) {
            ...
            case "orca":
              if (global.db.data.users[m.sender].money >= Borca * count) {
                ...
                conn.reply(
                  m.chat,
                  `Succes membeli  orca dengan harga ${
                    Borca * count
                  } money\n\n`,
                  m
                );
          ...
          switch (_type) {
            case "orca":
              if (global.db.data.users[m.sender].orca >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} orca dengan harga ${
                    Sorca * count
                  } money`.trim(),
                  m
                );
            ...
            case "ikan":
              if (global.db.data.users[m.sender].ikan >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} ikan  dengan harga ${
                    Sikan * count
                  } money`.trim(),
                  m
                );
            ...
            case "paus":
              if (global.db.data.users[m.sender].paus >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} paus  dengan harga ${
                    Spaus * count
                  } money`.trim(),
                  m
                );
            ...
            case "gurita":
              if (global.db.data.users[m.sender].gurita >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} gurita  dengan harga ${
                    Sgurita * count
                  } money`.trim(),
                  m
                );
            ...
            case "udang":
              if (global.db.data.users[m.sender].udang >= count * 1) {
                ...
                conn.reply(
                  m.chat,
                  `Succes menjual ${count} udang  dengan harga ${
                    Sudang * count
                  } money`.trim(),
                  m
                );
